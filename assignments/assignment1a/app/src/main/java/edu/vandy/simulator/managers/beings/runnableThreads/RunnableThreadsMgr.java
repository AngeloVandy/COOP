...
public class RunnableThreadsMgr
    ...
    void beginBeingThreads() {
        ...
        //
        // Also, set an "UncaughtExceptionHandler" for each being
        // thread that calls the BeingManager.error() method to
        // indicate an unexpected exception "ex" occurred for thread
        // "thr".  
        //
        // TODO -- you fill in here.
